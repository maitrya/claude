# Daily AI Intelligence Brief — Orchestrator Prompt

Copy this entire prompt into Claude Code (`claude -p "<prompt>"`) or paste into a Cowork `/schedule` task set to **daily at 8:00 AM**.
